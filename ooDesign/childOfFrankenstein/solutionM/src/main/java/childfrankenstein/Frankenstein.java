...
public class Frankenstein {
    ...
    private boolean isValidInformaton() {
        if (frankenPet.getFoodType() == null
            || frankenPet.getName() == null
            || frankenPet.getAnimalType() == null
            || frankenSong.getTitle() == null
            || frankenSong.getArtist() == null) {
            alphaAvg = 0;
            return false;
        }
